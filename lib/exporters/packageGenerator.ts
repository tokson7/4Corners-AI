...
Design tokens are the visual design atoms of the design system — specifically, they are named entities that store visual design attributes. They're used in place of hard-coded values (like hex values for color or pixels for spacing) to ensure flexibility and maintainability.
...
**Generated with ❤️ by [4Corners AI](https://4corners.ai)**
